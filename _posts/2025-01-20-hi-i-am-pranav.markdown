...
> "You haven't accomplished anything yet, you don't deserve to talk about this". 

If that's what you think, then: your ego > your work. I have completed 4 years of college and now on route for an MS CSE in the University of Michigan, and learned nothing but one thing which is: stay away from backward minded people or simply ignore them. 

<h2></h2>

I would like to say my college life was successful. I know I lived a complete, all-rounded 4 years in the outskirts of Chennai (a town I am not really fond of anymore). Here's what I would classify as all-rounded:
...
But your GPA should NEVER be below a 9. NEVER. The competition today will crush you in a stampede. A lot of people will have 10 CGPA until the end of their second year. Be it jobs or higher studies, if your GPA is high, you will be preferred in whatever situation your resume is in. Some grad school programs and companies are very GPA-centric. A low GPA will always be your losing factor.
...
**A small rant on terrible research.** There was no push for independent research: peers start following each other down a narrow path of finishing college with a high GPA, getting some internships and subsequently securing a job with a 10 LPA+ package. 
...
<h2> II. Industry Internships </h2>

So you look at people around you with internships and you get the worst FOMO. You also `want` to do one. You blindly apply to top companies and feel its impossible and quit. <b>Beggars can't be choosers</b>, you realize that later. You start applying to random companies, get an interview, mess up and get rejected. You quit again.

Here's what you need to change if you're someone who really `wants` to work in a CS job: 

> If you're okay with a 5-7 LPA package then skip to the next section.

**Join TECH CLUBS**. You need to INVOLVE yourself into things. Start applying to clubs in your college. Some clubs will be difficult to get in. Don't join a "festival" club, its just politics. The environment changes, and you find hardworking people who you start competing with. It will help you become better over time.
- You'll find people working on projects and you'll learn from them. 
- The more people you know the more you'll realize that `you're not alone`, and that will help you in your journey. 
- You can join their hackathon groups and create projects. 
- Perks include: team meetings, attending workshops and connecting with strong alumni.

**Do a couple of hackathons**. Honestly in Indian colleges, hackathons play a major role. No doubt, its the best way to learn how to code and build frontend/backend/ai models. If you win a prize, your resume polishes. Even if you don't win, you'll have projects to show during interviews.

**DSA**. As much as I hate DSA too, it does bring a solid foundation to your CS skills. What I did was really study DSA which was a part of my course in college, it helped me build logic and practice. Consistently solving Leetcode problems will really help. Start with 10-15 easy problems. Get the gist of it by understanding how basic code is written, what the input/output format looks like in a DSA problem and how to submit responses. There are a lot of students who don't know how to submit Leetcode/hackerrank codes during a coding test. The format is the same everywhere, just shows you never actually solved DSA problems. 
...
The simple way out of this is to engage in hackathons. Go on Coursera and learn a few skills. There are Coursera projects as well that will get you experience in understanding problems and developing code simultaneously. And you need to keep on applying and applying.
...
- odyssey lab
- elective polling
- create a small qna of how people might hate on me and write answers for it. example "so you think going to the US is being successful?" (no i dont mean that at all)
